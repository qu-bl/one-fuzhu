...
4. **AI 规则**：仅供对应的 AI 脚本调用。生成与交付要求在 `ai-rules/guidance.json`，按 `scenarios.applicationScript` 或 `scenarios.resourcePackage` 选择场景。`ai-rules/rules.json` 给 AI 资料提供版本与 SHA-256。
